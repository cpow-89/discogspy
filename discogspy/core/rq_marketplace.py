...
__all__ = ['get_inventory', 'get_listing', 'update_listing', 'delete_listing']
...
# Cell
def update_listing(user: Union[UserWithUserTokenBasedAuthentication],
                   listing_id: int,
                   release_id: int,
...
# Cell
def delete_listing(user: Union[UserWithUserTokenBasedAuthentication],
                   listing_id: int
                   ) -> requests.models.Response:
    """
