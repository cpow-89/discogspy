...
__all__ = ['BASE_URL', 'RELEASES_URL', 'MASTERS_URL', 'ARTIST_URL', 'LABEL_URL', 'USERS_URL', 'MARKETPLACE_URL',
           'LISTINGS_URL', 'ORDERS_URL', 'FEE_URL', 'CurrAbbr', 'SortOptionsMaster', 'SortOptionsArtist',
           'SortOptionsLabel', 'SortOptionsInventory', 'SortOptionsOrders', 'SortOrder', 'StatusInventory',
